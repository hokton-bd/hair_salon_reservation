<?php include 'header.php' ; ?>
    ...
    <section class="hero-area set-bg" data-setbg="img/top.jpg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="intro-left">
                        <div class="section-title">
                            <span>Fitting you</span>
                            <h2>Offering a special experience</h2>
                        </div>
    ...
    <section class="facilities-section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <div class="facilities-item set-bg" data-setbg="img/expert_staff.jpg">
                        <div class="fi-title">
                            <h2>Expert Staff</h2>
                            <!-- <p></p> -->
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="facilities-item set-bg fi-right" data-setbg="img/environment.jpg">
                        <div class="fi-title">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-text">
                        <div class="section-title">
                            <h2>“Customers love our <br />skills & hospitalities”</h2>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="about-img">
                                <img src="img/three_women.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="about-img">
                        ...
                        <div class="col-sm-6">
                            <div class="about-img">
                                <img src="img/a_girl.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="about-img">
                                <img src="img/dynamic.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
